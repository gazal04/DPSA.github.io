				...
				<div class="col-md-12">
					<div class="row">
						...
						<div class="col-md-6">
							...
							<dl>
								<dt><b class="border-bottom border-primary">Team leader</b></dt>
								<dd>
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					...
					<div class="card-tools">
						<button class="btn btn-primary bg-gradient-primary btn-sm" type="button" id="new_productivity"><i class="fa fa-plus"></i> Give Update</button>
					</div>
				</div>
				<div class="card-body">
					<?php 
